...
TESTS=(cancel_token pipe_progress job_future json_options pcm_buffer_range lease_registry utf8_utils audio_gate audio_utils_ingress inference_stop_signal scoped_timer buffer_pool sha256 marian_session_config)
